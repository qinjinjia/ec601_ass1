...
## Project Description :bowtie:
   ...
   * Practice **Agile software development [(Scrum)](https://en.wikipedia.org/wiki/Scrum_(software_development))** with a colleague
   ...
   #### :first_quarter_moon: Some samples are picked from the OpenCV [Samples folder :briefcase:](https://github.com/opencv/opencv/tree/master/samples) in order to conducting the Homework, create_mask.cpp for instance.
